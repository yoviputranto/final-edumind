...
<head>
    ...
    <body>
        ...
        <aside class="position-fixed main-sidebar bg-white" id="sidebar">
            <div class="rounded sidebar-item {{ request()->is('user/dashboard') ? 'active' : '' }}">
                <a href="{{ url('user/dashboard') }}" class=""><i class="fa fa-home me-3"></i>Dashboard</a>
            </div>
            <div class="rounded sidebar-item {{ request()->is('user/event-diikuti') || request()->is('user/event-diupload') ? 'active' : '' }}"
            ...
            <div class="rounded sidebar-item {{ request()->is('user/profil/' . Auth::user()->id) ? 'active' : '' }}">
                <a href="{{ route('user.profil', Auth::user()->id) }}" class=""><i
