        ...
        <div class="container d-flex justify-content-center">
            <nav class="breadcrumb my-2" aria-label="breadcrumb">
                <ol class="list-group list-group-horizontal">
                    ...
                    <li class="breadcrumb-item"><a href="Link">Jawaban</a></li>
                </ol>
            </nav>
        </div>
    </section>
                        ...
                        <div class="article-comment mt-4">
                            <div class="article-comment-display my-5">
                                ...
                                <div class="comment-text">
                                    ...
                                    <img class="img-fluid my-3" src="{{ url('frontend/assets/ic/blank.png') }}"
                                        alt="photo">
                                    <p>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <button type="submit" class="btn p-1 ms-auto">
                                            Tanyakan <span><img class="m-0"
                                                    src="{{ url('frontend/assets/ic/send.png') }}" width="20px"></span>
                                        </button>
                                    </div>
                                </div>
                            </div>
