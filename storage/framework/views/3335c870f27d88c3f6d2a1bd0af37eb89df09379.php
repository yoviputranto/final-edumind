        ...
        <div class="container d-flex justify-content-center">
            <nav class="breadcrumb my-2" aria-label="breadcrumb">
                <ol class="list-group list-group-horizontal">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('sejarah')}}">Sejarah</a></li>
                </ol>
            </nav>
        </div>
    </section>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Yovi\Kuliah\Lomba\olivia\Final\edumind\resources\views/frontend/profil/sejarah.blade.php ENDPATH**/ ?>
