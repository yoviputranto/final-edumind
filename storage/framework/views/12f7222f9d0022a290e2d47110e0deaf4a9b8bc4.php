<?php $__env->startPush('stylePlus'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend/style/event-style.css')); ?>">
<?php $__env->stopPush(); ?>
                                ...
                                <div class="card mx-auto scale-up" style="width: 280px;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-act d-flex justify-content-between mt-3">
                                            ...
                                            <?php else: ?>
                                                <a href="#" class="btn btn-webinar-price">Rp. <?php echo number_format($event->harga, 0, ',', '.'); ?></a>
                                            <?php endif; ?>
                                            <a href="<?php echo e(route('detailevent', $event->slug)); ?>"
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Yovi\Kuliah\Lomba\olivia\Final\hosting 2\resources\views/frontend/search.blade.php ENDPATH**/ ?>