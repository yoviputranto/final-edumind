            ...
            <div class="infografis-body">
                <div class="row">
                    <div class="col-12 col-lg-4 img-col">
                        <img src="<?php echo e(asset('frontend')); ?>/assets/illustration/ill-14.png" width="260px">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 img-col-alt">
                        <img src="<?php echo e(asset('frontend')); ?>/assets/illustration/ill-15.png" width="300px">
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-12 col-lg-4 img-col">
                        <img src="<?php echo e(asset('frontend')); ?>/assets/illustration/ill-16.png" width="260px">
                    </div>
                    <div class="col-12 col-lg-8 text-col">
                        <p>
                            Tahukah kamu?
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Yovi\Kuliah\Lomba\olivia\Final\edumind\resources\views/frontend/profil/infografis.blade.php ENDPATH**/ ?>
