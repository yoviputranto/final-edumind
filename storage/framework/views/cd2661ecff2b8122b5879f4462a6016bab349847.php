                ...
                <div class="row">
                    <div class="col-6 col-lg-3">
                        <a href="" class=" text-decoration-none">
                            <div class="contact-item text-center">
                                <img class="my-2" src="<?php echo e(url('frontend/assets/ic/instagram-svg.svg')); ?>"
                                    width="100px">
                                <h5>Instagram</h5>
                                <p>@edumind.idn</p>
                            </div>
                    ...
                    <div class="col-6 col-lg-3">
                        <a href="" class=" text-decoration-none">
                            <div class="contact-item text-center">
                                <img class="my-2"
                                    src="<?php echo e(url('frontend/assets/ic/instagram-purple-svg.svg')); ?>" width="100px">
                                <h5>Instagram</h5>
                                <p>@edumind.idn</p>
                            </div>
                        </a>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arsyandipratama/laravel8/olivia21/resources/views/frontend/profil/contact.blade.php ENDPATH**/ ?>
