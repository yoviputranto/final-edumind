        ...
        <div class="container nav-container">
            ...
            <?php if(!Auth::user()): ?>
                <div class="collapse navbar-collapse" id="navbarNav"
                    style="min-height: 1vh; border-end-end-radius: 10px; border-end-start-radius: 10px;">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <div>
                                <form class="d-flex search-form" action="<?php echo e(route('search')); ?>" method="GET">
                ...
                <div class="col-6 col-lg-4">
                    ...
                    <div class="contact-list text-white">
                        ...
                        <div class="contact-item">
                            ...
                            <a href="https://wa.me/089632101841">089632101841</a>
                        </div>
                        <div class="contact-item">
                            <img src="<?php echo e(url('frontend/assets/ic/telegram.png')); ?>">
                            <a href="https://t.me/yoviputranto">089632101841</a>
                        </div>
                        <div class="contact-item">
                            <img src="<?php echo e(url('frontend/assets/ic/email.png')); ?>">
                            <a href="mailto:edumindindonesia@gmail.com">edumindindonesia@gmail.com</a>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-2">
                    ...
                    <div class="social-list text-white">
                        <div class="social-item">
                            ...
                            <a href="https://instagram.com/edumind.idn?utm_medium=copy_link">instagram</a>
                        </div>
                        <div class="social-item">
                            <img src="<?php echo e(url('frontend/assets/ic/facebook.png')); ?>">
                            <a href="https://www.facebook.com/profile.php?id=100074144358440&_rdc=1&_rdr">facebook</a>
                        </div>
                        <div class="social-item">
                            <img src="<?php echo e(url('frontend/assets/ic/twitter.png')); ?>">
                            <a href="https://twitter.com/EdumindIdn?t=lFz1c7bGloT--TBpUrgLWA&s=08">twitter</a>
                        </div>
                        <div class="social-item">
                            <img src="<?php echo e(url('frontend/assets/ic/web.png')); ?>">
                            <a href="https://edumind.id">web</a>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-4">
                    ...
                    <div class="sitemap-item">
                        <a href="<?php echo e(route('sitemap')); ?>" class="text-white text-decoration-none">sitemap</a>
                    </div>
                </div>
                <div class="col-2">
...
<?php /**PATH D:\Yovi\Kuliah\Lomba\olivia\Final\hosting 2\resources\views/frontend/layouts/master.blade.php ENDPATH**/ ?>