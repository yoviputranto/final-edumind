        ...
        <div class="container d-flex justify-content-center">
            <nav class="breadcrumb my-2" aria-label="breadcrumb">
                <ol class="list-group list-group-horizontal">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('sejarah')); ?>">Sejarah</a></li>
                </ol>
            </nav>
        </div>
    </section>
        ...
        <div class="container mt-5">
            ...
            <div class="history-body">
                <div class="history-body-img text-center mb-5">
                    <img src="<?php echo e(url('frontend/assets/ic/sejarah.png')); ?>" alt="gedung vokasi IPB" width="700px"
                        class="img-fluid scale-up">
                </div>
                <div class="history-body-text">
                    <p>Program pendidikan Diploma dibuka pertama kali oleh IPB pada tahun 1979. Pada tahun
                        ...
                        Pemerintah No. 30 Tahun 1990 Fakultas Politeknik Pertanian ditiadakan dan program-program diploma
                        yang berada dibawahnya harus diintegrasikan dalam fakultas yang relevan. Selanjutnya sejak
                    ...
                    <p>Pada awal dibuka tahun 2004 Program Diploma IPB menyelenggarakan 13 Program Keahlian
                        ...
                        Program Keahlian Akuntansi (SK Rektor Nomor 176/K13/PP/2006 tanggal 29 Desember 2006). Pada tahun
                        2007 dibuka 2 program keahlian lagi yang merupakan program taylor made yaitu Program
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Yovi\Kuliah\Lomba\olivia\Final\hosting 2\resources\views/frontend/profil/sejarah.blade.php ENDPATH**/ ?>