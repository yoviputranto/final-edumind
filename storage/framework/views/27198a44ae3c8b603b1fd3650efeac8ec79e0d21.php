...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="card mx-auto scale-up" style="width: 280px;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-act d-flex justify-content-between mt-3">
                                        <?php if($webinar->harga == 0): ?>
                                            <a href="#" class="btn btn-webinar-price">Gratis</a>
                                        <?php else: ?>
                                            <a href="#" class="btn btn-webinar-price">Rp. <?php echo number_format($webinar->harga, 0, ',', '.'); ?></a>
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('detailevent', $webinar->slug)); ?>"
                        ...
                        <div class="col-12 col-lg-3 py-3">
                            <div class="card mx-auto scale-up" style="width: 280px;">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr widt>
                                    <div class="card-act d-flex justify-content-between mt-3">
                                        <?php if($workshop->harga == 0): ?>
                                            <a href="#" class="btn btn-webinar-price">Gratis</a>
                                        <?php else: ?>
                                            <a href="#" class="btn btn-webinar-price">Rp. <?php echo number_format($workshop->harga, 0, ',', '.'); ?></a>
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('detailevent', $workshop->slug)); ?>"
                                            class="btn btn-primary-none btn-webinar-action">Detail</a>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Kursus -->
    <section class="webinar mt-5 mb-2">
        <div class="container mt-3">
            <!-- Webinar list section -->
            <div class="webinar-heading mx-auto text-center mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-act d-flex justify-content-between mt-3">
                                        <?php if($kursus->harga == 0): ?>
                                            <a href="#" class="btn btn-webinar-price">Gratis</a>
                                        <?php else: ?>
                                            <a href="#" class="btn btn-webinar-price">Rp. <?php echo number_format($kursus->harga, 0, ',', '.'); ?></a>
                                        <?php endif; ?>

                                        <a href="<?php echo e(route('detailevent', $kursus->slug)); ?>"
                                            class="btn btn-primary-none btn-webinar-action">Detail</a>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Yovi\Kuliah\Lomba\olivia\Final\hosting 2\resources\views/frontend/event/event.blade.php ENDPATH**/ ?>