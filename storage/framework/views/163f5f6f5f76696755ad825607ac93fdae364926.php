                            ...
                            <div class="article-comment-box">
                                ...
                                <div class="d-flex">
                                    ...
                                    <button type="submit" class="btn  ms-auto">
                                        Tanyakan <span><img src="<?php echo e(url('frontend/assets/ic/send.png')); ?>"
                                                width="20px"></span>
                                    </button>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Yovi\Kuliah\Lomba\olivia\Final\edumind\resources\views/frontend/diskusi/timeline.blade.php ENDPATH**/ ?>
